...
export const UserCard = ({
  ...
  return (
    ...
    >
      <View
        className="android:border-[3px]  rounded-2xl border-2
       border-dashed border-black bg-[#FFFFBC] p-6"
      >
        <View className="absolute -top-4 right-10 rounded-2xl bg-primary-orange-100 px-4 py-2">
